...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (jobId && !window.location.href.endsWith("modules/stock/") && !window.location.href.endsWith("modules/scanning/")) {
        ...
        `;
    } else if (!window.location.href.endsWith("modules/stock/") && !window.location.href.endsWith("modules/scanning/")){
        multiActionContainer.innerHTML = `
        <button class='action-button'><span class='fa fa-plus'></span></button>
        <ul class='actions'>
